...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3),
	    FuzzySearch = __webpack_require__(2),
	    _someData = __webpack_require__(1);
	...
	var TestComponent = React.createClass({
		...
		onSearchChange: function onSearchChange(selected) {
			this.setState({ selected: selected });
		}
	});
	
	React.render(React.createElement(TestComponent, null), document.getElementById("content"));
	// The name of the id (or other field) per object in the items array to use as a key property for results)
	// An array (or Immutable.js List)
	// The name of the property to display as results
	// The number of item to display when not searching
	// The minimum score to place in the list. minScore is multiplied by the number of search terms.
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3);
	var PriorityQueue = __webpack_require__(30);
	var cx = __webpack_require__(31);
	var containsNode = __webpack_require__(6);
	var JaroWinkler = __webpack_require__(7);
	
	var SearchWorker = __webpack_require__(8);
	...
	var FuzzySearchResult = React.createClass({
		...
		render: function render() {
			var colorStyle = "rgba(48,48,48," + this.props.score + ")";
	
			return React.createElement(
				"li",
				{ className: "fuzzy-search-result", onClick: this.props.selectItem && this.select, style: this.props.style },
				React.createElement(
					"div",
					{ className: "inline-top", style: { paddingLeft: 4, marginTop: 2, color: colorStyle } },
					React.createElement(
						"div",
						null,
		...
		render: function render() {
			...
			return React.createElement(
				...
				this.state.active && React.createElement(
					"ul",
					{ className: "fuzzy-results-cont" },
					items.map(function (result) {
						return React.createElement(this.props.resultsComponent, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		get: function get(str1, str2) {
			...
			var jaroDist;
			if (str1 == str2) jaroDist = 1;else if (!str1.length || !str2.length) jaroDist = 0;else {
				...
				if (!matches) {
					...
					for (var i = 0; i < str1Flags.length; i++) {
						if (str1Flags[i]) {
							...
							if (str1Flags[i] != str2Flags[j]) transpositions += 1;
						}
					}
